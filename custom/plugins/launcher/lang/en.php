...
return [
  ...
  'loading type'             => 'Loading type',
    'patch' => 'Patch',
    'full game' => 'Full game',
    'patch desc' => 'The patch is the complete version of the game. It is recommended to use it for the latest versions of the game.',
    'full game desc' => 'The full game is the complete version of the game. It is recommended to use it for the latest versions of the game.',
];