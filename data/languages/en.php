...
return [
	...
	'records' => 'records',
	'Clear' => 'Clear',
	'Date range exceeds' => 'Date range exceeds %s days',
	'Showing first %s days' => 'Showing first %s days',
	'Preview full' => 'Preview full',
	'Full range records' => 'Full range records',
	'Confirm deletion' => 'Confirm deletion',
	'This action will delete donations in the selected date range.' => 'This action will delete donations in the selected date range.',
	...
	'connection_check.network_status' => 'Network & Connectivity',
	'connection_check.mysql_status' => 'MySQL Server Info',
	...
	'connection_check.error.too_many_ports' => 'You may specify up to 5 ports',
	...
	'referral_inviter_nick' => 'Inviting user nickname',
	'317' => 'PvP',
	'318' => 'PK',
	'319' => 'Game chats',
	'320' => 'Caching',
	...
	'auth_log' => 'Login History',
	'auth_log_history' => 'Account Login History',
	'history' => 'History',
	...
	'bonus_code_group_already_activated' => 'You have already activated a bonus from the \'%s\' series on your account',
	...
	'buy_for' => 'Buy for',
	'startpack_recently_bought' => 'You recently purchased a startpack. Try again in %s',
	'discount_active_until' => 'Discount %s%% active until %s',
	'time_days_short' => 'd',
...
attach them to the message.
	...
	'Disabled in server settings' => 'Disabled in server settings',
	'disabled' => 'Disabled',
	'discord' => 'Discord',
	'discount_item_ids' => 'List of item IDs eligible for discounts. If empty, the discount applies to all items.',
	'discount_percentage' => 'Discount percentage',
	'discount_from_desc' => 'Discount period start date and time',
	'discount_to_desc' => 'Discount period end date and time',
	'discount_percent_desc' => 'Enter a number from 0 to 100',
...
It will not be possible to connect to servers that are set up in a local network.',
	...
	'forum posts per day' => 'Forum posts per day',
	'forum_connection_settings' => 'Forum connection settings',
	'forum_db_connection' => 'Forum database connection',
	'forum_description_limit' => 'Once the post quota has been used, it will not be possible to add a post to the forum. The update counter is reset every day.',
...
You can get the CAPTCHA keys here - <a href=\'https://www.google.com/recaptcha/admin/create\'>Register on Google\'s site</a>',
  ...
  <p class=\'card-text\'>There is an option to check the stream\'s validity (whether there is a stream on the channel) until date N, but no more than 31 days. The stream check on the user\'s channel happens approximately every 15 minutes. This option is useful if you have agreed with the streamer on the duration of their streaming on your server.</p>
	...
	'LOG_DONATE_SUCCESS' => 'The user donated and received %f Donate Coin using the %s payment system',
	'log_in' => 'Log in',
	...
	'LOG_USER_BUY_STARTPACK' => 'User bought startpack - %s',
	'LOG_USER_BUY_STARTPACK_TO_PLAYER' => 'User bought starter pack "%s" for %s Donate Coin and sent it to character %s (account: %s). Pack contents: %s',
...
37*3.15 = 116.55 online users, the result is rounded up to the nearest whole number, giving 117 online users.',
	...
	'payment_system_custom_name' => 'Custom payment system name',
	'payment_system_custom_name_hint' => 'Shown in the payment system selection modal. Leave empty to use the default name.',
	'payment_system_hide_name' => 'Hide payment system name',
	'payment_system_hide_name_hint' => 'When enabled, the payment system name is hidden in the selection modal.',
	'payment_page_title_with_name' => 'Top up via %s',
	'payment_page_title_without_name' => 'Balance top-up',
	'payment_page_description' => 'Enter the amount and proceed to payment.',
	'payment_page_secure_note' => 'Secure balance top-up',
...
The Sphere Server API (from Sphere Web) allows you to connect to the game server database and manage game accounts.',
	...
	'packs' => 'Packs',
	'settings' => 'Settings',
	'settings_apply_notice' => 'Attention: settings apply only to server %s',
	'how_often_buy_packs' => 'How often packs can be purchased',
	'no_limits' => 'No limits (0)',
	...
	'custom_seconds' => 'Custom (in seconds)',
	'choose_preset_or_custom' => 'Choose a preset or specify your own value in seconds.',
	'value_seconds' => 'Value (sec.)',
	'zero_no_limits' => '0 = no limits',
	'discount_from' => 'Discount from',
	'discount_to' => 'Discount to',
	'discount_percent_label' => 'Discount percent',
	'save_settings' => 'Save settings',
	'server_time_notice' => 'Server time: %s — for correct planning use this time.',
	'edit_pack' => 'Edit pack',
	'delete_pack' => 'Delete pack',
	'editing_pack' => 'Editing pack',
	'save_changes' => 'Save changes',
	'select_item_and_quantity' => 'You must select an item and specify the quantity',
	'fill_name_and_cost' => 'You must fill the name and cost fields',
	'add_at_least_one_item' => 'You must add at least one item',
	'fill_fields' => 'You must fill the fields',
	'status' => 'Status',
	...
	'Here are your requests in category' => 'Here are your requests in category',
	'Here are all your requests to technical support' => 'Here are all your requests to technical support.',
	'from' => 'from',
	'No support requests' => 'No support requests',
	'You have not created any support requests yet' => 'You have not created any support requests yet',
	'Create first request' => 'Create first request',
	'Create your first support request' => 'Create your first support request',
...
Password: %%password%%',
	...
	'Time on the SphereApi server' => 'Time on the SphereApi server',
 ...
 We are here to help you!</h6>',
	...
	'plugin_is_disabled_need_active' => 'The plugin is disabled.<br>Only enabled plugins can be configured.',
	...
	'amateur' => 'Amateur',
	'for_server_building_beginners' => 'For beginners in server building',
	'max_connectable_servers_count' => '<strong class="me-1">10 servers</strong> - number of connectable servers',
	'max_game_accounts_per_day' => '<strong class="me-1">10,000 registrations</strong> - game accounts per day',
	'professional' => 'Professional',
	'path_to_legend' => 'Path to legend',
	'optional_services' => 'You can connect some services separately',

	'traffic_sources' => 'Traffic sources',
	'referral_sources' => 'Referral sources',
	'transition_diagram' => 'Transition diagram',
	'main_php_parameters' => 'Main PHP parameters',
	'security_parameters' => 'Security parameters',
	'critical_php_extensions' => 'Critical PHP extensions',
	'file_upload_settings' => 'File upload settings',
	'session_settings' => 'Session settings',
	'system_information' => 'System information',
	'system_resources' => 'System resources',
	'advanced_php_settings' => 'Advanced PHP settings',
	'network_settings' => 'Network settings',
	'php_version' => 'PHP version',
	'php_version_is_up_to_date' => 'PHP version is up to date',
	'php_version_update_recommended' => 'It is recommended to update PHP to the latest version',
	'php_interface' => 'PHP interface',
	'informational_parameter' => 'Informational parameter',
	'php_memory_limit' => 'PHP memory limit',
	'recommended_to_disable_for_security' => 'It is recommended to disable for security',
	'php_version_display' => 'PHP version display',
	'properly_configured' => 'Properly configured',
	'url_wrappers_permission' => 'URL wrappers permission',
	'disable_if_not_used' => 'Disable if not used',
	'error_display' => 'Error display',
	'disable_on_production_server' => 'Disable on production server',
	'required_for_working_with_mysql' => 'Required for working with MySQL',
	'required_for_secure_database_operation' => 'Required for secure database operation',
	'required_for_working_with_images' => 'Required for working with images',
	'required_for_external_api_requests' => 'Required for external API requests',
	'critical_for_security' => 'Critical for security',
	'installed_t' => 'Installed (%s)',
	'installed' => 'Installed',
	'not_installed' => 'Not installed',
	'maximum_file_size' => 'Maximum file size',
	'at_least_10mb_is_recommended' => 'At least 10MB is recommended',
	'maximum_post_size' => 'Maximum POST size',
	'must_be_greater_than_upload_max_filesize' => 'Must be greater than upload_max_filesize',
	'maximum_number_of_files' => 'Maximum number of files',
	'20_or_more_is_recommended' => '20 or more is recommended',
	'session_lifetime' => 'Session lifetime',
	'1440_seconds_or_more_is_recommended' => '1440 seconds or more is recommended',
	'secure_cookies' => 'Secure cookies',
	'enable_for_https' => 'Enable for HTTPS',
	'operating_system' => 'Operating system',
	'unknown' => 'Unknown',
	'web_server' => 'Web server',
	'recommended_apache_or_nginx_latest_versions' => 'It is recommended to use the latest versions of Apache or Nginx',
	'system_architecture' => 'System architecture',
	'php_memory_usage' => 'PHP memory usage',
	'current_memory_usage_by_script' => 'Current memory usage by the script',
	'peak_memory_usage' => 'Peak memory usage',
	'maximum_memory_usage_by_script' => 'Maximum memory usage by the script',
	'error_reading_file' => 'Error reading file',
	'memory_information' => 'Memory information',
	'open_basedir_restriction_prevents_retrieving_information' => 'The open_basedir restriction prevents retrieving information',
	'processor_information' => 'Processor information',
	'access_to_system_information' => 'Access to system information',
	'check_open_basedir_settings_for_access_to_proc' => 'Check open_basedir settings for access to /proc',
	'error_retrieving_data' => 'Error retrieving data',
	'average_load' => 'Average load',
	'check_permissions_and_system_limits' => 'Check permissions and system limits',
	'recommended_to_enable_for_performance_improvement' => 'It is recommended to enable for performance improvement',
	'maximum_input_variables' => 'Maximum input variables',
	'3000_plus_is_recommended_for_cms' => '3000+ is recommended for CMS',
	'max_execution_time' => 'Max execution time',
	'30_plus_seconds_is_recommended' => '30+ seconds is recommended',
	'error_reporting_level' => 'Error reporting level',
	'e_all_is_recommended_for_development' => 'E_ALL is recommended for development',
	'socket_timeout' => 'Socket timeout',
	'60_plus_seconds_is_recommended' => '60+ seconds is recommended',
	'output_buffering' => 'Output buffering',
	'it_is_recommended_to_enable' => 'It is recommended to enable',
	'great_memory_limit' => 'Great memory limit',
	'sufficient_memory' => 'Sufficient memory',
	'it_is_recommended_to_increase_to_256m' => 'It is recommended to increase to 256M',
	'critical_memory_shortage_increase_limit' => 'Critical memory shortage, increase the limit',
	'total_system_memory' => 'Total system memory',
	'server_physical_memory_size' => 'Server physical memory size',
	'available_memory' => 'Available memory',
	'sufficient_free_memory' => 'Sufficient free memory',
	'it_is_recommended_to_free_up_memory' => 'It is recommended to free up memory',
	'memory_usage' => 'Memory usage',
	'normal_usage' => 'Normal usage',
	'high_memory_usage' => 'High memory usage',
	'processor_model' => 'Processor model',
	'server_cpu_information' => 'Server CPU information',
	'number_of_cpu_cores' => 'Number of CPU cores',
	'sufficient_cores_for_processing_requests' => 'Sufficient cores for processing requests',
	'it_is_recommended_to_increase_the_number_of_cores' => 'It is recommended to increase the number of cores',
	'average_load_1_5_15_min' => 'Average load (1/5/15 min)',
	'normal_system_load' => 'Normal system load',
	'high_load_optimization_required' => 'High load, optimization required',
	'error_retrieving_cpu_cores_count' => 'Error retrieving the number of CPU cores',
	'installed_but_disabled' => 'Installed but disabled',
	'overall_summary' => 'Overall summary',
	'optimal' => 'Optimal',
	'requires_attention' => 'Requires attention',
	'critical_issues' => 'Critical issues',
	'informational' => 'Informational',
	'server_optimization_recommendation' => '<strong>Recommendation:</strong> Pay attention to parameters with the status "Requires attention" and "Critical issues" to optimize server performance.',
	'license_agreement' => '<h1 class="text-center mb-4">SPHEREWEB SOFTWARE LICENSE AGREEMENT</h1>
<h2>1. GENERAL PROVISIONS</h2>
<p>1.1. This License Agreement (hereinafter referred to as the "Agreement") governs the use of the SphereWeb software (hereinafter referred to as the "Software").</p>
<p>1.2. Use of the Software is permitted only upon full acceptance of the terms of this Agreement.</p>
<p>1.3. The Licensor (developer) grants the Licensee (user) the right to use the Software under the terms set forth in this Agreement.</p>
<h2>2. LICENSE RIGHTS AND RESTRICTIONS</h2>
<p>2.1. The Licensor grants the user a non-exclusive right to use the Software.</p>
<p>2.2. The user is not permitted to:</p>
<ul>
    <li>Modify the system files of the Software without the Licensor\'s consent.</li>
    <li>Bypass or attempt to bypass the Software\'s protection mechanisms, including those intended for paid services.</li>
    <li>Modify, decompile, disassemble, or otherwise attempt to derive the source code of the Software.</li>
    <li>Use the Software for illegal activities that violate the law.</li>
</ul>
<p>2.3. In case of violation of these restrictions, the Licensor reserves the right to terminate the user\'s service and revoke their license without refund.</p>
<h2>3. DISCLAIMER OF WARRANTIES AND LIABILITY</h2>
<p>3.1. The Software is provided "as is." The Licensor is not responsible for any errors, malfunctions, or damages arising from the use of the Software.</p>
<p>3.2. The Licensor does not guarantee uninterrupted operation of the Software and is not liable for any consequences of using or being unable to use the Software.</p>
<h2>4. UPDATES AND SUPPORT</h2>
<p>4.1. The Licensor may release updates to the Software, which may include bug fixes, new features, or changes in the Software\'s functionality.</p>
<p>4.2. The Licensor may cease providing updates and technical support in case of violation of the terms of this Agreement.</p>
<h2>5. MISCELLANEOUS</h2>
<p>5.1. The Licensor reserves the right to modify the terms of this Agreement without prior notice.</p>
<p>5.2. Continued use of the Software after changes to the Agreement constitutes acceptance of the new terms.</p>
<p>5.3. All disputes arising from this Agreement shall be resolved in accordance with the laws of the Licensor\'s country of registration.</p>
<h2>6. PROCESSING OF PERSONAL DATA</h2>
<p>6.1. The Licensor has the right to collect and process users\' personal data necessary for the proper functioning of the Software, including for caching and displaying required additional data.</p>
<p>6.2. The processing of personal data is carried out in accordance with applicable laws and is solely aimed at improving the quality of the services provided.</p>
<p>6.3. The user has the right to request information about the processed personal data and demand their update or deletion in cases provided by law.</p>
<p class="mt-4 text-center">By accepting this Agreement, you confirm that you have read and agree to its terms.</p>',
	'server_errors_documentation' => 'While working with your server, we encountered errors and documented them so you can track and resolve the issues.',
	'delete_error_list_after_resolution' => 'If you have resolved the errors, please delete the error list. This will unlock the execution of functions that were causing errors.',
	'delete_errors' => 'Delete errors',
	'error_message' => 'Error message',
	'result' => 'Result',
	'license' => 'License',
	'license_ticker_expired' => 'SphereWeb license has expired 😿, please renew it.',
	'license_ticker_l2wow' => 'If you need a server, check <a target="_blank" class="text-warning" href="https://l2wow.com?utm_source=mywebsite&utm_medium=referral&utm_content=sidebar_link">l2wow.com</a>',
	'license_ticker_sphereweb' => 'Need a quality site for your server? Choose <a target="_blank" class="text-warning" href="https://sphereweb.com">sphereweb.com</a>',
	...
	'all_logs' => 'All logs',
	'DISABLED' => '%s: payment plugin is disabled',
	'NOT_CONFIGURED' => '%s: payment plugin is not configured',
	'INVALID_METHOD' => '%s: invalid request method',
	'TOKEN_INVALID' => '%s: invalid token',
	'INVOICE_ID_MISSING' => '%s: invoice ID is missing',
	'API_ERROR' => '%s: API error',
	'PAYMENT_NOT_CONFIRMED' => '%s: payment is not confirmed',
	'UUID_CONTROL_FAILED' => '%s: UUID validation failed',
	'INVALID_USER_ID' => '%s: invalid user ID',
	'PAYMENT_SUCCESS' => '%s: payment processed successfully',
	'PROCESS_ERROR' => '%s: processing error',
	'LOG_REGISTRATION_ACCOUNT_DESC' => 'Registration of game accounts',
	'LOG_LOGIN_DESC' => 'Logins',
	'LOG_DONATE_SUCCESS_DESC' => 'Donations',
	'LOG_CHANGE_ACCOUNT_PASSWORD_DESC' => 'Password changes',
	'LOG_ADD_DONATE_ITEM_BONUS_DESC' => 'Item bonuses for donations',
	'LOG_INVENTORY_TO_GAME_DESC' => 'Sending items to the game',
	'LOG_DONATE_COIN_TO_GAME_DESC' => 'Sending donations to the game',
	'LOG_USER_CHANGE_PROFILE_DESC' => 'Profile data changes',
	'LOG_CHANGE_AVATAR_DESC' => 'Avatar changes',
	'LOG_REGISTRATION_USER_DESC' => 'New user registrations',
	'LOG_BONUS_CODE_DESC' => 'Bonus codes',
	'LOG_SAVE_CONFIG_DESC' => 'Configuration saving',
	'LOG_WHEEL_WIN_DESC' => 'Roulette games',
	...
	'Last year' => 'Last year',
	'All time' => 'All time',
	'Distribution by payment system' => 'Distribution by payment system',
	'Monthly comparison' => 'Monthly comparison',
	'Donation growth trend' => 'Donation growth trend',
	'Donation activity heatmap' => 'Donation activity heatmap',
	'No donations' => 'No donations',
	'Low' => 'Low',
	'Medium' => 'Medium',
	'High' => 'High',
	'donations' => 'donations',
	'Donations by day and hour' => 'Donations by day and hour',
	'Donations' => 'Donations',
	'Donate Points' => 'Donate Points',
	'points' => 'points',
	'Cumulative donations' => 'Cumulative donations',
	'Points' => 'Points',
	'Total' => 'Total',
	'Copy' => 'Copy',
	'Print' => 'Print',
	...
	'Message' => 'Message',
	'Date' => 'Date',
	'item_split' => 'Item split ID: %s into %s and %s',
	'no_items_provided' => 'No items provided',
	'no_quantity_provided' => 'No quantity provided',
	'minimum_one_item' => 'Minimum 1 item',
	'item_not_found' => 'Item not found',
	'item_not_stackable' => 'Item is not stackable',
	'item_magic_protected' => 'This item is created with the best magic, even an admin can\'t break it',
	'item_quantity_exceeded' => 'Item quantity exceeded',
	'not_enough_items' => 'Not enough items',
	'item_split_success' => 'Item split successfully',
	'no_account_provided' => 'No account provided',
	'no_player_name_provided' => 'No player name provided',
	'items_not_found_in_warehouse' => 'Items not found in warehouse',
	'unstack' => 'Unstack',
	'unstack_item' => 'Unstack item',
	'unstack_item_count_desc' => 'Specify the number of items to unstack',
	'unstack_item_count_min_1' => 'The quantity cannot be greater than available or less than 1',
	'stack_items' => 'Stack items',
	'unstack_success' => 'Item successfully unstacked',
	'error_unstack_success' => 'Error while unstacking item',
	'warehouse_is_empty' => 'There are no items in the warehouse to send',
	'success_stack' => 'Items successfully stacked',
	'error_stack' => 'Error while stacking items',
	'min_1_item_for_send' => 'Select at least one item to send',
	'clear_warehouse' => 'Clear warehouse',
	'item_unstack_menu' => 'Item splitting',
	'load_all_items' => 'Load all user items',
	'i_confirm_that_i_want_to_clear_the_warehouse_of_the_selected_character' => 'I confirm that I want to clear the warehouse of the selected character',
	'information' => 'Information',
	'why_might_warehouse_clearance_be_needed' => 'Why might warehouse clearance be needed?',
	'before_server_start_to_remove_all_items' => 'Before server start to remove all items',
	'prepare_characters_for_transfer_to_another_server' => 'Prepare characters for transfer to another server',
	'fix_incorrect_items_in_the_warehouse' => 'Fix incorrect items in the warehouse',
	'remove_specific_unused_items' => 'Remove specific unused items',
	'this_operation_is_performed_directly_with_the_server_database_and_may_take_some_time_please_wait_for_the_operation_to_complete_after_pressing_the_button' => 'This operation is performed directly with the server database and may take some time. Please wait for the operation to complete after pressing the button.',
	'operation_log' => 'Operation log',
	'operation_log_empty' => 'Operation log is empty',
	'item_list_in_warehouse' => 'Item list in warehouse',
	'data_loading' => 'Data loading',
	'item_list_loaded' => 'Item list loaded',
	'warehouse_empty' => 'Warehouse is empty',
	'items_in_warehouse_not_found' => 'Items in warehouse not found',
	'warehouse_empty_no_items_found' => 'Warehouse is empty. No items found.',
	'data_loading_error' => 'Data loading error',
	'failed_to_load_item_list' => 'Failed to load item list',
	'search_by_name_or_id' => 'Search by name or ID',
	'note' => 'Note',
	'actions' => 'Actions',
	'add_to_deletion' => 'Add to deletion',
	'total_items' => 'Total items',
	'enter_item_id' => 'Enter item ID',
	'in_progress' => 'In progress',
	'operation_successful' => 'Operation successful',
	'successful' => 'Successful',
	'operation_completed_successfully' => 'Operation completed successfully',
	'if_certain_item_ids_need_to_be_removed_from_the_warehouse' => 'If certain item IDs need to be removed from the warehouse',
	'add_item_id' => 'Add item ID',
	'attention' => 'Attention!',
	'this_operation_will_lead_to_the_complete_removal_of_all_items_from_the_warehouse_the_action_is_irreversible' => 'This operation will lead to the complete removal of all items from the warehouse. The action is irreversible!',
	'this_function_allows_to_set_item_stack_you_can_specify_which_items_can_be_split' => 'This function allows you to configure item stacking. You can specify which items can be split into parts (for example, if a user has 400 items, they can split them into 100 and 300).',
	'items_that_can_be_split' => 'Items that can be split',
	'allow_split_of_all_items' => 'Allow splitting of all items',
	'if_enabled_all_items_can_be_split_otherwise_only_specified_items' => 'If enabled, all items can be split into parts. Otherwise, only specified items will be allowed to split.',
	'add_item_id_for_splitting' => 'Add item ID for splitting',
	'add' => 'Add',
	'item_name' => 'Item name',
	'split_item_list_empty' => 'Split item list is empty',
	'item_connection_settings' => 'Item connection settings',
	'allow_connection_of_all_items' => 'Allow connection of all items',
	'if_enabled_all_items_can_be_connected_otherwise_only_specified_items' => 'If enabled, all items can be connected together. Otherwise, only specified items will be allowed to connect.',
	'add_item_id_for_connection' => 'Add item ID for connection',
	'connection_item_list_empty' => 'Connection item list is empty',
	'save_settings' => 'Save settings',
	'this_item_is_already_added_to_the_list' => 'This item is already added to the list',
	'please_enter_a_valid_item_id' => 'Please enter a valid item ID',
	'item_with_specified_id_is_not_stackable' => 'Item with specified ID is not stackable',
	'item_with_specified_id_not_found' => 'Item with specified ID not found',
	'stacking_item_settings_saved_successfully' => 'Stacking item settings saved successfully',
	'func_server' => 'Server functions',
	'confirm_delete' => 'Confirm deletion',
	'delete_account_confirm' => 'Confirm account deletion',
	'delete_account_desc' => 'The account will be removed from the account list, the account will still be available in the game.',
	'no' => 'No',
	...
	'initial_set_successfully_bought' => 'Initial set successfully purchased',
	'preview' => 'Preview',
	'type' => 'Type',
	'items_many' => 'Items',
	...
	'valid' => 'Valid',
	'invalid' => 'Invalid',
	'ssl_certificate_desc' => 'It is important to have an SSL certificate to ensure security.',
	'domain' => 'Domain',
	'deadlines' => 'Deadlines',
	'update_ssl' => 'Get Certificate',
	'get a certificate' => 'Renew Certificates',
	'no_ssl_certificates' => '<strong>Attention!</strong> No certificate data',
	'no_ssl_certificates_desc' => 'The certificate might be missing or unavailable.<br>Without an SSL certificate, the server will not be served.<br>Please attach an SSL certificate.<br>Rechecking every 10 min.',
	...
	'LOG_WAREHOUSE_ADD' => 'Item added to user\'s warehouse (server: %s) Item ID: %s | quantity: %s | enchant: +%s | Phrase: %s',
	'LOG_BUY_SHOP_ITEM' => 'User bought an item in the shop and sent it to a player. Player Name: %s | Shop ID: %s | Item ID: %s | quantity: %s | enchant: +%s',
	'LOG_BUY_SHOP_ITEM_DESC' => 'Purchase of an item in the shop',
	'LOG_BUY_START_PACK_DESC' => 'Starter pack purchase',
	'LOG_ITEM_SPLITED_DESC' => 'Splitting items',
	'LOG_ITEM_SPLITED' => 'User split an item into two. Item ID: %s | quantity #1: %s | quantity #2: +%s',
	'LOG_ITEM_STACK_DESC' => 'Combining items',
	'LOG_ITEM_STACK' => 'User combined items in inventory',
	'LOG_DELETE_ACCOUNT_DESC' => 'Deleting accounts',
	'LOG_DELETE_ACCOUNT' => 'Deleted account %s from the list of accounts',
	'LOG_WAREHOUSE_ADD_DESC' => 'Added to users warehouse',
	'add_donate_page_notice' => 'Additional information or notice on the donation page',
	'telegram_support' => 'Support',
	'telegram_donate' => 'Donations',
	'telegram_send_to_game' => 'Send to Game',
	'telegram_registration' => 'Registration',
	'telegram_create_account' => 'Created Accounts',
	'telegram_recovery_password' => 'Password Recovery',
	'telegram_account_change_password' => 'Account Password Change',
	'telegram_profile_change_password' => 'Profile Password Change',
	'telegram_sync' => 'Synchronization',
	'telegram_stream' => 'Streams',
	'telegram_wheel' => 'Roulette',
	'telegram_bonus_code' => 'Bonus Code',
	'telegram_buy_start_set' => 'Buy Starter Pack',
	...
	'error_save_platform' => 'Unable to save for this platform',

	"minimumNumberOfCharactersRegistrationAccount" => "Minimum number of characters in account",
	"maximumNumberOfCharactersRegistrationAccount" => "Maximum number of characters in account",
	...
	// Support phrases
	'Отправка сообщений не чаще чем раз в 10 сек.' => 'Sending messages no more than once every 10 seconds',
	'Пользователь %s (%s) обратился в техническую поддержку\n<a href=\'%s\'>Открыть ссылку</a>' => 'User %s (%s) contacted technical support\n<a href=\'%s\'>Open link</a>',
	'Создано' => 'Created',
	'Не более 6 изображений можно прикрепить к сообщению.' => 'No more than 6 images can be attached to a message.',
	'У Вас нет прав отвечать в данном диалоге' => 'You do not have permission to reply in this dialogue',
	'Пользователь %s (%s) написал сообщение в техническую поддержку\n<a href=\'%s\'>Открыть ссылку</a>' => 'User %s (%s) wrote a message to technical support\n<a href=\'%s\'>Open link</a>',
	'Добавлен' => 'Added',
	'Добавлено' => 'Added',
	'Удалено' => 'Deleted',
	'Диалог удален' => 'Dialogue deleted',
	'Нет ID объекта' => 'No object ID',
	'Запрещенное действие' => 'Forbidden action',
	'Обновлено' => 'Updated',
	'Тема была открыта' => 'Topic was opened',
	'Тема была закрыта' => 'Topic was closed',
	'У Вас нет прав на выполнение этого действия' => 'You do not have permission to perform this action',
	'Вы загрузили больше 6 изображений за последние 10 минут.' => 'You have uploaded more than 6 images in the last 10 minutes.',
	'Одновременно можно загрузить не более 6 изображений' => 'No more than 6 images can be uploaded at once',
	'Error saving thumbnail: ' => 'Error saving thumbnail: ',
	'Error saving image: ' => 'Error saving image: ',
	'Error uploading file with index: ' => 'Error uploading file with index: ',
	'No files uploaded' => 'No files uploaded',
	'Запрещено' => 'Forbidden',
	'Перемещено' => 'Moved',
	'Ошибка' => 'Error',
	'No phrase' => 'No phrase',
	'Phrase ID is empty' => 'Phrase ID is empty',
	'IDs empty' => 'IDs empty',
	...
	'Ваши обращения:' => 'Your requests:',
	'Here are your requests category' => 'Here are your requests in the "%s" category.',
	'Here are all your requests support' => 'Here are all your requests to technical support.',
	'Нет выбранных элементов' => 'No selected items',
	'Back to inbox' => 'Back to inbox',
	'Refresh' => 'Refresh',
    'Analyzing data and searching for multiaccounts' => 'Analyzing data and searching for multiaccounts...',
    ...
    'i_agree_newsletter' => 'I agree to receive news and promo codes',
	...
	'current_announcements_and_updates' => 'Current announcements and project updates',
	'sphereweb_news_and_team_chat' => 'Section for SphereWeb news and team chat',
	'game_server_news' => 'Section for game server news',
	'updates_and_innovations' => 'Updates and innovations',
	'server_updates_and_features' => 'Section for posting server updates and new features',
	'sphereweb_installation_success' => 'SphereWeb installation completed successfully',
	'clan_section' => 'Clan section',
	'clan_discussion_recruitment' => 'Discussion of clan matters, recruitment, and clan interactions',
	'clans_seeking_members' => 'For clans seeking new members',
	'players_seeking_clan' => 'For players seeking a clan to join',
	'general_discussion' => 'Discussion of any topics, arguing for the sake of arguing',
	'offtopic_conversations' => 'Conversations on off-topic subjects',
	'creativity_hobbies_fun' => 'Creativity, mischief, hobbies, humor',
	'archive' => 'Archive',
	...
	'items_send_date_hint' => 'Date until sending items is blocked (dd/mm/yyyy)',
	'items_send_timezone_hint' => 'To change the server time zone, update the PHP setting on the hosting (date.timezone) or set the time zone in the admin panel in the server settings section.',
	'items_send_title' => 'Item delivery time',
	'items_send_description' => 'Set the date and time from which items can be delivered to players. Until that moment, the issuing will be blocked.',
	'items_send_toggle' => 'Enable delivery time restriction',
	'items_send_toggle_hint' => 'When the switch is off, items can be delivered at any time.',
	'items_send_date_label' => 'Date',
	'items_send_time_label' => 'Time',
	'items_send_time_hint' => '24-hour format (HH:MM)',
	'items_send_quick_select' => 'Quick selection',
	'items_send_quick_1h' => '+1 hour',
	'items_send_quick_3h' => '+3 hours',
	'items_send_quick_12h' => '+12 hours',
	'items_send_quick_1d' => '+1 day',
	'items_send_quick_2d' => '+2 days',
	'items_send_quick_hint' => 'Values are calculated relative to the current server time',
	'items_send_current_time' => 'Current server time',
	'items_send_reference_note' => 'All checks and quick presets are based on this time so players in different time zones gain access simultaneously.',
	'items_send_tips_title' => 'Tips',
	'items_send_tip_no_past' => 'Do not set a date in the past — the delivery will become available immediately.',
	'items_send_tip_disable' => 'Leave the restriction disabled if delivery should always be available.',
	'items_send_tip_apply' => 'After saving, the new values take effect instantly.',
	'items_send_current_threshold' => 'Current threshold',
	'items_send_threshold_unset' => 'No threshold set (restriction disabled)',
	'items_send_notice_apply' => 'After saving, the new time takes effect immediately.',
	'items_send_reset_button' => 'Reset',
	'items_send_enter_datetime' => 'Enter the delivery date and time',
	'items_send_server_time_error' => 'Failed to get the server time. Please refresh the page.',
	'items_send_fill_datetime' => 'Specify the date and time first.',
	'items_send_save_success' => 'Settings saved',
	'items_send_save_error' => 'Failed to save settings',
	'items_send_show_time_label' => 'Show from what time you can send items to the game?',
	'items_send_show_time_hint' => 'If disabled, the warehouse will display the message "Items cannot be sent to the game at this time." instead of the exact time.',
	'items_send_show_time_title' => 'Delivery time visibility settings',
	'items_send_show_time_description' => 'Configure whether users see the exact time items can be sent to the game.',
	'items_send_show_time_when_enabled' => 'When enabled:',
	'items_send_show_time_enabled_text' => 'Users see: "Items will be available in 3 days and 50 minutes (29.11.2025 22:00 Europe/Kyiv)"',
	'items_send_show_time_when_disabled' => 'When disabled:',
	'items_send_show_time_disabled_text' => 'Users see: "Items cannot be sent to the game at this time."',
	'items_send_show_time_notice' => 'After saving, this setting takes effect immediately.',
	'Write' => 'Write',
	'Write to user' => 'Write to user',
	'Support category' => 'Support category',
	'Select category for request' => 'Select category for request',
	'Search user' => 'Search user',
	'Enter name, email or user ID' => 'Enter name, email or user ID',
	...
	'cancel' => 'Cancel',
	'Mass message sending' => 'Mass message sending',
	'Message will be sent to' => 'Message will be sent to',
	'selected users' => 'selected users',
	'Message' => 'Message',
	'Enter message text that will be sent to all selected users' => 'Enter message text that will be sent to all selected users',
	'Send' => 'Send',
	...
	'Existing dialog opened' => 'Existing dialog opened',
	'Dialog created successfully' => 'Dialog created successfully',
	'No users specified for sending' => 'No users specified for sending',
	'Cannot send empty message' => 'Cannot send empty message',
	'User with ID %s not found' => 'User with ID %s not found',
	'Error sending to user ID %s' => 'Error sending to user ID %s',
	'Sent %s of %s messages' => 'Sent %s of %s messages',
	'Enter minimum' => 'Enter minimum',
	...
	'Creating dialog' => 'Creating dialog',
	'Error: thread ID not received' => 'Error: thread ID not received',
	'Error creating dialog' => 'Error creating dialog',
	...
	'2fa_setup' => 'Set up 2FA',
	'2fa_active' => '2FA is active',
	'2fa_active_description' => 'Your account is protected with two-factor authentication',
	'2fa_disable_warning' => 'Disabling 2FA will reduce the security of your account. You will need to enter a code from the authenticator app to confirm.',
	'2fa_enter_code' => 'Enter the 6-digit code',
	'2fa_code_hint' => 'Enter the code from Google Authenticator or compatible app',
	'2fa_enable' => 'Enable 2FA',
	'2fa_disable' => 'Disable 2FA',
	'2fa_setup_intro' => 'Two-factor authentication adds an extra layer of security to your account by requiring a verification code in addition to your password.',
	'2fa_step1_title' => 'Install an authenticator app',
	'2fa_step2_title' => 'Scan the QR code',
	'2fa_step3_title' => 'Enter verification code',
	'2fa_secret_key' => 'Secret key',
	...
	'2fa_missing_data' => 'Missing required data',
	'2fa_not_available_oauth' => '2FA is not available for Google/Telegram accounts',
	'2fa_required' => 'Two-factor authentication required',
	'2fa_verify_title' => 'Two-Factor Verification',
	'2fa_verify_description' => 'Enter the verification code from your authenticator app to complete login',
	'2fa_verify_button' => 'Verify',
	'2fa_verifying' => 'Verifying...',
	'2fa_help_title' => 'Need help?',
	'2fa_help_text' => 'Open your authenticator app (like Google Authenticator) and enter the 6-digit code displayed for this account.',
	'back_to_login' => 'Back to login',
	'warning' => 'Warning',
	'copied' => 'Copied to clipboard',
	'copy' => 'Copy',
	'custom_routers_title' => 'Custom routers',
	'custom_routers' => 'Custom',
	'route_pattern' => 'Pattern',
	'route_type' => 'Type',
	'route_type_method' => 'Method',
	'route_type_file' => 'File',
	'route_type_link' => 'Link',
	'route_type_debug' => 'Debug',
	'route_link_url' => 'URL',
	'route_namespace' => 'Name Space',
	'route_access' => 'Access',
	'route_access_user' => 'User',
	'route_access_admin' => 'Admin',
	'route_access_guest' => 'Guest',
	'route_access_any' => 'Any',
	'route_method' => 'Method',
	'route_method_get' => 'GET',
	'route_method_post' => 'POST',
	'route_method_any' => 'Any',
	'route_weight' => 'Weight',
	'route_comment' => 'Comment',
	'route_edit_title' => 'Edit custom router',
	'route_create_title' => 'Create custom router',
	'route_table_method' => 'Method',
	'route_table_pattern' => 'Pattern',
	'route_table_func' => 'Func',
	'route_table_access' => 'Access',
	'route_table_comment' => 'Comment',
	'route_error_filled_required' => 'Fill in all required fields',
	'route_error_pattern_exists' => 'A route with this pattern and method already exists in custom routes!',
	'route_warning_pattern_builtin' => 'Warning: pattern {{pattern}} {{method}} already exists in built-in routes!\n\nDo you want to continue? Your route may conflict with the built-in one.',
	'route_confirm_delete' => 'Are you sure you want to delete this route?',
	'route_error_pattern_empty' => 'Pattern is empty',
	'route_table_search' => 'Search...',
	...
	'support_welcome' => '<strong>Welcome to technical support!</strong> This is your first request. Please describe your issue in as much detail as possible.',
	'l2mod_description' => 'L2MOD — a platform with the best mods for Lineage 2. Free mods are available here, and you can also order custom mods for your server or needs.',
	'stream_no_channel' => 'No channel selected',
	'stream_invalid_url' => 'Channel must be a valid URL',
	'stream_no_data' => 'No stream data',
	'stream_approved' => 'Stream approved',
	'stream_deleted' => 'Stream deleted',
	'stream_supported_platforms' => 'Only streams from Youtube, Twitch, Kick and Trovo are supported',
	'stream_not_approved_cant_add' => 'Your stream has not been approved yet; you cannot add a new link. Please wait for administrator approval',
	'stream_added_wait_approval' => 'Stream added. Please wait for administrator approval',
	'stream_not_selected' => 'No stream selected',
	'stream_cannot_delete' => 'You cannot delete this stream',
	'discount' => 'Discount',
	'load_from_another_server' => 'Load from another server',
	'global_donate_settings_description' => 'The global page manages rewards and bonuses for donations. Changes are saved to a unified configuration.',
	'automatic_currency_rate_enabled' => 'Automatic currency rate retrieval is enabled.',
	'currency_ratio_block_not_applied' => 'The "currency ratio" block will not be applied.',
	'discounts_and_bonuses' => 'Discounts and bonuses',
	'error_input_fields_not_found' => 'Error: input fields not found',
	'please_fill_both_fields' => 'Please fill both fields',
	'enter_tab_name' => 'Enter tab name',
	'tab_name_already_exists' => 'A tab with this name already exists',
	'no_data_to_load' => 'No data to load',
	'error_loading_server_data' => 'Error loading data from server',
	'item' => 'Item',
	'quantity' => 'Quantity',
	'enchant' => 'Enchant',
	'confirm_copy_settings_overwrite' => 'Are you sure you want to copy settings from server "..." to server "..."?\\n\\nCurrent settings of the target server will be overwritten!',
	'save_order' => 'Save order',
	'configure_payment_systems_drag_to_reorder' => 'Configure payment systems for accepting donations. Drag cards with the mouse to change the display order.',
	'drag_to_reorder' => 'Drag to reorder',
	'settings' => 'Settings',
	'payment_systems_not_found' => 'Payment systems not found',
	'install_paysystem_plugins' => 'Install payment system plugins of category "paysystem" to accept donations.',
