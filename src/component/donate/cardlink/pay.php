...
class cardlink extends \Ofey\Logan22\model\donate\pay_abstract
{

    protected static string $webhook = "/donate/webhook/cardlink";
    ...
    protected static string $name = 'Сardlink';
    ...
    {
        if (!(config::load()->donate()->getDonateSystems('cardlink')?->isEnable() ?? false)) {
            echo 'disabled';
            exit;
        }
