...
class enot extends \Ofey\Logan22\model\donate\pay_abstract
{
    ...
    function transfer(): void
    {
        ...
        file_put_contents( __DIR__ . '/debug.log', 'START_REQUEST: ' . $jsonTxt . PHP_EOL, FILE_APPEND );
        ...
        if ($status == "success") {
            ...
            file_put_contents( __DIR__ . '/debug_invoice_data.log', '_REQUEST: ' . print_r( $invoice['data'], true ) . PHP_EOL, FILE_APPEND );
            ...
            $order = $invoice['custom_fields']['order'] ?? null;
