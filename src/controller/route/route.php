...
class route
{
    ...
    static function add()
    {
        ...
        sql::run(
          "INSERT INTO `route` ( `enable`, `method`, `pattern`, `func`, `access`, `weight`, `page`, `comment`) VALUES (1, ?, ?, ?, ?, ?, ?, ?)",
          [
            $method,
            $pattern,
            $func,
    ...
    static function edit()
    {
        ...
        if ($access) {
            $access = json_encode($access);
            sql::run(
              "UPDATE `route` SET `method` = ?, `pattern` = ?, `func` = ?, `access` = ?, `weight` = ?, `page` = ?, `comment` = ? WHERE `id` = ?",
              [
                $method,
                $pattern,
                $func,
            ...
            sql::run(
              "UPDATE `route` SET `method` = ?, `pattern` = ?, `func` = ?, `weight` = ?, `page` = ?, `comment` = ? WHERE `id` = ?",
              [
                $method,
                $pattern,
                $func,
