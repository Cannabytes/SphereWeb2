...
class donateConfig
{
    ...
    private $table_CumulativeDiscountSystem = [];

    private bool $enableOneTimeBonus = false;

    private $table_EnableOneTimeBonus = [];

    private bool $enableSystemDiscountsOnItemPurchases = false;

    private $table_SystemDiscountsOnItemPurchases = [];

    private bool $enableIncludeOneTimeDiscountsOnThePurchaseOfItemsByQuantity = false;

    private $table_IncludeOneTimeDiscountsOnThePurchaseOfItemsByQuantity = [];

    private $table_ListOfItemsForDiscount = [];

    private bool $rewardForDonatingItems = false;

    private $tableItemsBonus = [];
