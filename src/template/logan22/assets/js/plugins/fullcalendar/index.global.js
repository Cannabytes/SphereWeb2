...
var FullCalendar = (function (exports) {
    ...
    */
    function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context, defIdMap) {
        ...
        // help out EventImpl from having userModel modify props
    ...
    */
    ...
    class EventImpl {
        ...
        */
        ...
        // NOTE: userModel can't modify these because Object.freeze was called in event-def parsing
    ...
    */
    ...
    class Popover extends BaseComponent {
        constructor() {
            ...
            // Triggered when the userModel clicks *anywhere* in the document, for the autoHide feature
    ...
    */
    ...
    /*
    Detects when the userModel clicks on an event within a DateComponent
    */
    ...
    /*
    Triggers events and adds/removes core classNames when the userModel's pointer
    ...
    */
    class PointerDragging {
        ...
        // can be called by userModel of this class, to cancel touch-based scrolling for the current drag
        cancelTouchScroll() {
            if (this.isDragging) {
    ...
    class AutoScroller {
        ...
        buildCaches(scrollStartEl) {
            return this.queryScrollEls(scrollStartEl).map((el) => {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to userModel-generated scrolls
                }
                return new ElementScrollGeomCache(el, false); // false = don't listen to userModel-generated scrolls
            });
        }
    ...
    */
    class FeaturefulElementDragging extends ElementDragging {
        constructor(containerEl, selector) {
            ...
            this.isInteracting = false; // is the userModel validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the userModel clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the userModel selects a portion of time of a component,
    ...
    class DateSelecting extends Interaction {
        constructor(settings) {
            ...
            this.handlePointerDown = (ev) => {
                ...
                // if touch, require userModel to hold down
